...
from occdepth.data.sweeper.sweeper_dataset import SwepperDataset
...
class SweeperDataModule(pl.LightningDataModule):
    def __init__(
        self,
        root,
        preprocess_root,
